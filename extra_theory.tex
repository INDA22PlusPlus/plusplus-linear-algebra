...
\nt{$A^T A$ och $A A^T$ är symmetriska matriser!}
...
\nt{
	Ni kommer inte finna denna definition direkt användbar, det är inte någon formel på det viset. 
	Tanken är att det hjälper med resonemangsförmågan att tänka i termer om delrum och summor av delrum.
}

\ex{orthogonal complements}
{
...
\thm{Dimension of vector space sums}
{
...
\bt{Tenta 2021-04-09 6b, (Använd att $A$ och $A^T A$ har samma radrum och att $A^T A$ är alltid symmetrisk)}
{
...
\tip{Hur beräknar man $A^n\vec{x}$ om $A$ \textbf{inte} är diagonaliserbar?}
{
...
\bt{Tenta 2020-10-19 5b, (Motsägelsebevis)}
{
